...
8. **Write design doc** — `.claude/tcoder/YYYY-MM-DD-<topic>/design-<topic>.md` (no commit — gitignored transient state). Follow **See:** `design-spec.md` for the authoritative section structure (8 always-required + 5 conditional sections, canonical order, cross-reference rules).
